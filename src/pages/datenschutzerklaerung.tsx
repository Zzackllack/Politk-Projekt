...
const Datenschutzerklaerung = () => {
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <p className="mb-4">
        Willkommen zu unserer Datenschutzerklärung. Wir nehmen den Schutz Ihrer
      ...
      <p className="mb-4">
        Beim Besuch der Website: Beim Aufrufen unserer Website werden durch den
      ...
      <h2 className="text-2xl font-semibold mb-2">4. Weitergabe von Daten</h2>
      <p className="mb-4">
